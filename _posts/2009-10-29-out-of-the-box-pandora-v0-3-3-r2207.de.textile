...
<a href="<%=r 'files/blog/collection_0_3_3.png' %>"><img src="<%=r 'files/blog/collection_0_3_3_small.png' %>" alt="Neuheiten in der Bildsammlung" /></a>
...
<ul>
  ...
  Unlike before, useradmins are now able to see accounts which have not yet verified their email addresses if they were created by a useradmin.</li>
