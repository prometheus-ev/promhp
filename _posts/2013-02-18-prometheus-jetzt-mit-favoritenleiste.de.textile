...
!(bordered-image)<%=r 'files/images/box03.de.png' %>(Screenshot: Ansicht Favoritenleiste)!

Mit nur einem Mausklick können Sie über den Button !(bordered-image)<%=r 'files/images/add_to_sidebar.png' %>(Screenshot: In Favoritenleiste ablegen)! eine Verknüpfung auf das gewünschte Bild aus der Trefferliste, Ihre Bildsammlung zum aktuellen Thema oder die entsprechende Präsentation in Ihrer Favoritenleiste ablegen. Die einzelnen Objekte werden als Boxen dargestellt, die Sie ein- und ausklappen können. Nach dem nächsten Login können Sie dann ohne erneute Suchanfrage oder Navigation über das Menü direkt und unkompliziert auf die Boxen zugreifen und mit den benötigten Bildern arbeiten.

!(bordered-image)<%=r 'files/images/box05.de.png' %>(Screenshot: Vergrößern der Box)!
