...
---
<img src="<%=r 'files/blog/fork_collection.png' %>" alt="Bildsammlung forken" />

Seit <a href="<%=r '2009/06/18/out-of-the-box-pandora-v0-1-8-r1775' %>" title="Out of the box: pandora v0.1.8 (r1775)">einiger Zeit</a> ist es im prometheus-Bildarchiv möglich, öffentliche <a href="<%=r '2009/08/19/nicht-einfach-nur-ein-bildarchiv' %>" title="Nicht einfach nur ein Bildarchiv">Bildsammlungen zu forken</a>. Das bedeutet, eine Kopie der Sammlung zu erstellen, deren Besitzer man dann ist. Dies macht z.B. dann Sinn, wenn ich eine öffentliche Bildsammlung gerne bearbeiten möchte, allerdings kein Schreibrecht auf die Sammlung habe.
