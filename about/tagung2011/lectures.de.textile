...
*Linked Open Cultural Heritage. Herausforderungen, Risiken und Chancen der Datenvernetzung im Bereich des Kulturerbes* "»PDF":<%=r '/files/text/10years_lectures/hohmann_linked-cultural-heritage.pdf' %> "»Video":<%=r 'http://vimeo.com/32315881' %>
...
*Motive vernetzen - Meta-Image als Bild-Zettelkasten* "»PDF":<%=r '/files/text/10years_lectures/warnke_meta-image.pdf' %> "»Video":<%=r 'http://vimeo.com/32325456' %>
...
*Medien und Begriffe: Ordnungsformen im Medienarchiv der Künste* "»PDF":<%=r '/files/text/10years_lectures/schumacher_media-archive.pdf' %> "»Video":<%=r 'http://vimeo.com/32440754' %>
...
*Informationsextraktion aus einer Kunst Folksonomie* "»PDF":<%=r '/files/text/10years_lectures/merkl_folksonomy.pdf' %> "»Video":<%=r 'http://vimeo.com/32447912' %>
...
*Das digitale Historische Archiv* "»Video":<%=r 'http://vimeo.com/32314294' %>
<br>
...
*Storytude - mobile storytelling* "»PDF":<%=r '/files/text/10years_lectures/horn_storytude.pdf' %> "»Video":<%=r 'http://vimeo.com/32513606' %>
...
*Mit dem Kulturwecker unterwegs - Kunst und Kultur mobil* "»PDF":<%=r '/files/text/10years_lectures/simon_kulturwecker.pdf' %>
