...
Permission to use them for other purposes, like publicising or making them available to the public requires authorization from Bild-Kunst.
...
The agreement with "Bild-Kunst":http://www.bildkunst.de/ which is mentioned above (see 2a) also permits making available the photographs of "works of art" within prometheus and utilizing them for research and educational purposes.

Permission to use them for other purposes, like publicising or making them available to the public requires authorization from the photographer or the responsable institution (e.g. image databases, publishers, Bild-Kunst). 

prometheus endeavours to name the appropriate copyright-holders of the photographs. On occasion, the user him/herself has to research the copyright. The indicated source of the image is usually helpful.
