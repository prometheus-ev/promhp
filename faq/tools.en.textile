...
# "Can I use image files from prometheus for examinations, term papers and M.A. theses?":#use
...
h3(#download). How I can download an image from prometheus?
...
h3(#show). I want to show images from prometheus on my private web site in the Internet. May I do that?
...
h3(#printing). Can I use image files from prometheus for the printing of my doctoral thesis?
...
h3(#use). Can I use image files from prometheus for examinations, term papers and M.A. theses?

Yes, you may, as long as they are exclusively used for your unpublished studies.

h3(#google). I like to search in google. What are the disadvantages?

Most images in google have a bad quality or the legend with the images is not correct.

h3(#domains). Why is it that in some domains many images can be found in prometheus, but not in others?
...
h3(#quality). Why is the quality of the images so different?
...
h3(#collection). What is an image collection?
...
h3(#presentation). What is an online presentation?
...
h3(#projektor). What is the projektor + editor?
...
h3(#offline). How can I establish a presentation in an off-line way?
