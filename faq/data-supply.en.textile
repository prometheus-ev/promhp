...
h3(#upload). We would like to upload our pictures in prometheus. What are the first steps?
...
"Information for database suppliers":<%=r 'databases' %>

h3(#digitalize). We intend to digitalize our slides. Is that recommended?
