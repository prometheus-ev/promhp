...
Wenn Sie an dem Erwerb einer Lizenz interessiert sind, besuchen Sie unsere Website unter "&lt;<%= @site.url %>/license/licence-fee&gt;":<%=r 'license/licence-fee' %> oder wenden Sie sich als VertreterIn einer Hochschule oder Institution direkt an das HBZ in Köln, Dr. Jochen Johannsen, Jülicher Straße 6, 50674 Köln, "inhalte@hbz-nrw.de":mailto:inhalte@hbz-nrw.de

Eine Liste aller Institutionen, die bereits eine Lizenz halten, finden Sie auf der prometheus-Website unter "&lt;<%= @site.url %>/license/licence-holders&gt;":<%=r 'license/licence-holders' %>
