...
Die Möglichkeit der Rückmeldung bzw. der Kontaktaufnahme mit dem prometheus-Team ist natürlich auch weiterhin per Telefon, E-Mail und Feedback-Formular ("http://prometheus.uni-koeln.de/pandora/de/feedback":<%= @site.pandora_url %>/feedback) gegeben.
