--- 
layout: default
title: "esPrix 2007 - Pr\xC3\xA4sentationsformen etruskischer Gr\xC3\xA4ber in Museen des 19. und 20. Jahrhunderts unter besonderer Ber\xC3\xBCcksichtigung der Tomba dei Rilievi in Cerveteri"
---
h2. <%= page_title %>
...
!<%=r "files/images/screen_architektur-klein.jpg" %>(screen architektur)!:<%=r "files/images/screen_architektur.jpg" %> !<%=r "files/images/screen_gens-klein.jpg" %>(screen gens)!:<%=r "files/images/screen_gens.jpg" %> !<%=r "files/images/screen_skylla-klein.jpg" %>(screen skylla)!:<%=r "files/images/screen_skylla.jpg" %>
